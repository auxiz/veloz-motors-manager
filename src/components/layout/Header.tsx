...
export const Header = ({
  ...
  return <header className="h-16 bg-veloz-black border-b border-veloz-gray flex items-center justify-between px-6">
      <div className="flex items-center gap-4">
        <button onClick={toggleSidebar} className="p-2 rounded-md hover:bg-veloz-gray text-veloz-white">
          <Menu size={24} />
        </button>
      ...
      <div className="flex items-center space-x-4">
        <button className="p-2 rounded-full hover:bg-veloz-gray text-veloz-white relative" onClick={handleNotificationsClick}>
          <Bell size={20} />
