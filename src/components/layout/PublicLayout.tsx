  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <header className="bg-veloz-black sticky top-0 z-50 shadow-lg">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="md:hidden flex items-center">
              ...
              <button 
                ...
                className="text-white hover:text-veloz-yellow"
              >
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-veloz-gray border-t border-gray-700 py-3">
            <div className="container mx-auto px-4">
              <nav className="flex flex-col space-y-3">
                <Link 
                  to="/" 
                  onClick={() => setMobileMenuOpen(false)}
                  className="text-white hover:text-veloz-yellow py-2 border-b border-gray-700"
                >
                  Home
                </Link>
                <Link 
                ...
                <Link 
                  to="/auth" 
                  onClick={() => setMobileMenuOpen(false)}
                  className="text-white hover:text-veloz-yellow py-2"
                >
                  Área Restrita
                </Link>
              </nav>
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 bg-[#25D366] hover:bg-[#20BA5C] text-white rounded-full p-4 shadow-lg transition-all hover:scale-110 z-50"
