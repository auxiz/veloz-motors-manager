...
const LeadsList: React.FC = () => {
  const { leads, selectedLead, selectLead, fetchLeads, isLoading, autoRefreshEnabled, toggleAutoRefresh } = useWhatsAppContext();
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              <Button
                ...
                className={`text-xs ${autoRefreshEnabled ? 'border-green-500 text-green-500' : 'border-gray-500 text-gray-500'}`}
              >
